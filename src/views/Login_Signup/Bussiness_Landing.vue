        ...
        <form @submit.prevent="submitForm">
          ...
          <div v-if="currentPage === 2">
            ...
            <div class="form-group mb-3 input-icon">
              ...
              <input type="text" v-model="form.city" class="form-control" id="city" placeholder="Enter city name"
                required />
            </div>
          </div>
          ...
          <div v-if="currentPage === 4">
            ...
            <div class="form-group mb-3 input-icon">
              ...
              <input type="text" v-model="form.cnic" class="form-control" id="cnic" placeholder="Enter your CNIC number"
                required />
            </div>
            <div class="form-group mb-3 input-icon">
            ...
            <div class="form-group mb-3 input-icon">
              ...
              <input type="text" v-model="form.iban" class="form-control" id="iban" placeholder="Enter your IBAN"
                required />
            </div>
            <div class="form-group mb-3 input-icon">
              <label for="account_owner_title">Account Owner Title</label>
              <i class="fas fa-user-tie text-primary"></i>
              <input type="text" v-model="form.account_owner_title" class="form-control" id="account_owner_title"
                placeholder="Enter account owner title" required />
            </div>
          </div>
