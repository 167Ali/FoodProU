<template>
                      ...
                      <form @submit.prevent="submitForm">
                          ...
                          <div v-if="currentPage === 2">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" v-model="form.restaurant_name" class="form-control" id="restaurant_name" placeholder="Enter restaurant name" required />
                              </div>
                              <div class="form-group mb-3">
                          ...
                          <div v-if="currentPage === 3">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" v-model="form.address" class="form-control" id="address" placeholder="Enter address" required />
                              </div>
                              <div class="form-group mb-3">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" v-model="form.city" class="form-control" id="city" placeholder="Enter city" required />
                              </div>
                          </div>
                          ...
                          <div v-if="currentPage === 4">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" v-model="form.cnic" class="form-control" id="cnic" placeholder="Enter CNIC" required />
                              </div>
                              <div class="form-group mb-3">
                                  <label for="bank_name">Bank Name</label>
                                  <input type="text" v-model="form.bank_name" class="form-control" id="bank_name" placeholder="Enter bank name" required />
                              </div>
                              <div class="form-group mb-3">
                                  <label for="iban">IBAN</label>
                                  <input type="text" v-model="form.iban" class="form-control" id="iban" placeholder="Enter IBAN" required />
                              </div>
                              <div class="form-group mb-3">
                          ...
                          <div class="form-navigation d-flex justify-content-between mt-4">
                              ...
                              <button type="submit" class="btn btn-success" v-if="currentPage === totalPages">Submit</button>
                          </div>
                      </form>
                  </div>
              </div>
  ...
  export default {
    setup() {
      ...
      const previewUrl = ref(null); // To hold the URL of the uploaded image
      ...
      const validateForm = (page) => {
        switch (page) {
          ...
          case 2:
            return form.value.restaurant_name && form.value.opening_time &&
                   form.value.closing_time && form.value.cuisine && form.value.logo_path &&
                   form.value.business_type;
          case 3:
            return form.value.address && form.value.postal_code && form.value.city;
          case 4:
            return form.value.cnic && form.value.bank_name && form.value.iban &&
      ...
      const submitForm = async () => {
        try {
          ...
          // Call the registerBusiness action from Vuex with the FormData
      ...
      const handleFileUpload = (event) => {
        ...
        if (file) {
          form.value.logo_path = file; // Store the file in the form object
  ...
  .signup-info {
    ...
    padding: 6rem; /* Moderate padding */
    margin: 0rem auto; /* Center the section */
  ...
  .signup-info-text h1 {
    ...
    color: #00754a; /* Brand color */
    margin-bottom: 1rem; /* Margin for separation */
  }
  
  .signup-info-text p {
    font-size: 1.2rem; /* Slightly larger text for readability */
    color: #555; /* Softer color for contrast */
  ...
  .signup-info-text ul li i {
    color: #00754a; /* Brand color for icons */
