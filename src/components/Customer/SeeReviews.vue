          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="review-filters mb-4">
                <button
                  class="filter-btn"
                  :class="{ active: activeFilter === 'top' }"
                  @click="setActiveFilter('top')"
                >Top reviews</button>
                <button
                  class="filter-btn"
                  :class="{ active: activeFilter === 'newest' }"
                  @click="setActiveFilter('newest')"
                >Newest</button>
                <button
                  class="filter-btn"
                  :class="{ active: activeFilter === 'highest' }"
                  @click="setActiveFilter('highest')"
                >Highest rating</button>
                <button
                  class="filter-btn"
                  :class="{ active: activeFilter === 'lowest' }"
                  @click="setActiveFilter('lowest')"
