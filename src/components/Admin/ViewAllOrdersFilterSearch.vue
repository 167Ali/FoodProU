            ...
            <div class="filter-section">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex justify-content-between">
                  <input type="number" class="form-control price-input" v-model="priceRange[0]" placeholder="Min" />
                  <input type="number" class="form-control price-input" v-model="priceRange[1]" placeholder="Max" />
                </div>
              </div>
