              ...
              <div class="card-body">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" v-model="restaurantDetails.address" class="form-control" id="address"
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" v-model="restaurantDetails.city" class="form-control" id="city"
